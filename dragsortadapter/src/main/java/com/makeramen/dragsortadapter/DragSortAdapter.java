...
public abstract class DragSortAdapter<VH extends DragSortAdapter.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    private final PointF lastTouchPoint = new PointF(); // used to create
                                                        // ShadowBuilder
    ...
    /**
     * This should be reasonably performant as it gets called a lot on the UI
     * thread.
     *
    ...
    /**
     * This is called during the dragging event, the actual positions of the
     * views and data need to change in the adapter for the drag animations to
     * look correct.
     *
    ...
    /**
     * You probably want to use this to set the currently dragging item to blank
     * while it's being dragged
     *
     * @return the id of the item currently being dragged or
     *         {@code RecyclerView.NO_ID } if not being dragged
     */
